...
// Measured in-browser, not re-derived: the helpers' own doc records why a
// naive `rgb(` regex reads fiction here. Shared with Slider, the other drawn
// control whose state IS a contrast no automated checker can see.
import { firstColour, contrast } from '../../test/contrast.js';
