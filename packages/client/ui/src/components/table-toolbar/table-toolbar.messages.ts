...
export const tableToolbarMessages = defineMessages('tableToolbar', {
  en: {
    ...
    unfiltered: 'Filters cleared, showing all rows',
    unfilteredCount: 'Filters cleared, showing all {total}',
  ...
  it: {
    ...
    unfiltered: 'Filtri annullati, tutte le righe',
    unfilteredCount: 'Filtri annullati, tutte le {total} righe',
  ...
  ar: {
    ...
    unfiltered: 'تم مسح عوامل التصفية، عرض كل الصفوف',
    unfilteredCount: 'تم مسح عوامل التصفية، عرض كل الصفوف البالغة {total}',
